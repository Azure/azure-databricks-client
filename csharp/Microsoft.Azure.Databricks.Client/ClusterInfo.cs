...
namespace Microsoft.Azure.Databricks.Client
{
    ...
    public class ClusterInfo : ClusterInstance
    {
        ...
        /// </remarks>
        [JsonProperty(PropertyName = "num_workers", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// For instance, if a cluster is resized from 5 to 10 workers, this field will immediately be updated to reflect the target size of 10 workers, whereas the workers listed in spark_info will gradually increase from 5 to 10 as the new nodes are provisioned.
        /// </remarks>
        [JsonProperty(PropertyName = "autoscale", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "cluster_name", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "spark_version", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "spark_conf", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "ssh_public_keys", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "custom_tags", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "cluster_log_conf", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "spark_env_vars", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "autotermination_minutes", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "cluster_source", DefaultValueHandling = DefaultValueHandling.Ignore)]
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "terminated_time", DefaultValueHandling = DefaultValueHandling.Ignore)]
        [JsonConverter(typeof(MillisecondEpochDateTimeConverter))]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "last_state_loss_time", DefaultValueHandling = DefaultValueHandling.Ignore)]
        [JsonConverter(typeof(MillisecondEpochDateTimeConverter))]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "last_activity_time", DefaultValueHandling = DefaultValueHandling.Ignore)]
        [JsonConverter(typeof(MillisecondEpochDateTimeConverter))]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "cluster_memory_mb", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "cluster_cores", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "default_tags", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public Dictionary<string, string> DefaultTags { get; set; }

        /// <summary>
        /// Cluster log delivery status.
        /// </summary>
        [JsonProperty(PropertyName = "cluster_log_status", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "termination_reason", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public TerminationReason TerminationReason { get; set; }

        [JsonProperty(PropertyName = "pinned_by_user_name", DefaultValueHandling = DefaultValueHandling.Ignore)]
