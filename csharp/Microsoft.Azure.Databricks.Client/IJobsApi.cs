...
namespace Microsoft.Azure.Databricks.Client
{
    public interface IJobsApi
    {
        ...
        /// </summary>
        Task<long> Create(JobSettings jobSettings);

        /// <summary>
        /// Lists all jobs.
        /// </summary>
        Task<IEnumerable<Job>> List();
        ...
        /// </param>
        Task Reset(long jobId, JobSettings newSettings);

        /// <summary>
        /// Runs the job now, and returns the run_id of the triggered run.
        /// </summary>
        Task<RunIdentifier> RunNow(long jobId, RunParameters runParams);
        ...
        /// </summary>
        Task<long> RunSubmit(RunOnceSettings settings);
