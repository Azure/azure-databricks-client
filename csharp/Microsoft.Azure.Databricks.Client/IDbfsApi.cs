...
namespace Microsoft.Azure.Databricks.Client
{
    public interface IDbfsApi
    {
        ...
        Task<long> Create(string path, bool overwrite);
        ...
        /// <returns></returns>
        Task AddBlock(long fileHandle, byte[] data);
        ...
        /// </summary>
        /// <param name="fileHandle">The handle on an open stream. This field is required.</param>
        Task Close(long fileHandle);

        /// <summary>
        /// Uploads a stream to the specified path
        /// </summary>
        Task Upload(string path, bool overwrite, Stream stream);
        ...
        /// <returns></returns>
        Task Delete(string path, bool recursive);
        ...
        Task<FileInfo> GetStatus(string path);

        /// <summary>
        /// Lists the specified path.
        /// </summary>
        /// <param name="path">The path of the file or directory. The path should be the absolute DBFS path (e.g. “/mnt/foo/”). This field is required.</param>
        Task<IEnumerable<FileInfo>> List(string path);
        ...
        /// <returns></returns>
        Task Move(string sourcePath, string destinationPath);
        ...
        /// <param name="overwrite">The flag that specifies whether to overwrite existing file/files.</param>
        Task Put(string path, byte[] contents, bool overwrite);
        ...
        Task<FileReadBlock> Read(string path, long offset, long length);

        /// <summary>
        /// Download the stream of the specified path to a stream.
        /// </summary>
        Task Download(string path, Stream stream);
    }
}
