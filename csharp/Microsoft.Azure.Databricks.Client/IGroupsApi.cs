...
namespace Microsoft.Azure.Databricks.Client
{
    public interface IGroupsApi : IDisposable
    {
        ...
        Task AddMember(string parentGroupName, PrincipalName principalName);
        ...
        Task<string> Create(string groupName);
        ...
        Task<IEnumerable<PrincipalName>> ListMembers(string groupName);
        ...
        Task<IEnumerable<string>> ListParent(PrincipalName principalName);
        ...
        /// <returns></returns>
        Task RemoveMember(string parentGroupName, PrincipalName principalName);
