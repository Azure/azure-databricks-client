...
namespace Microsoft.Azure.Databricks.Client
{
    public interface IWorkspaceApi : IDisposable
    {
        ...
        Task Import(string path, ExportFormat format, Language? language, byte[] content, bool overwrite);
        ...
        /// </summary>
        /// <param name="path">The absolute path of the notebook or directory. This field is required.</param>
        Task<IEnumerable<ObjectInfo>> List(string path);
