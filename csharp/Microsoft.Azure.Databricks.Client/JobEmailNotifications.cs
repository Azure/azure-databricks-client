...
namespace Microsoft.Azure.Databricks.Client
{
    public class JobEmailNotifications
    {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "on_start", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "on_success", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "on_failure", DefaultValueHandling = DefaultValueHandling.Ignore)]
