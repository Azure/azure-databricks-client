...
public interface IFilesApi : IDisposable
{
    ...
    /// </param>
    Task<(IEnumerable<DirectoryEntry>, string)> ListDirectoryContents(string directoryPath, long? pageSize = default, string pageToken = default, CancellationToken cancellationToken = default);
    ...
    /// If unspecified, at most 1000 directory entries will be returned. The maximum value is 1000. Values above 1000 will be coerced to 1000.
    /// </param>
    global::Azure.AsyncPageable<DirectoryEntry> ListDirectoryContentsPageable(string directoryPath, long? pageSize = default, CancellationToken cancellationToken = default);
