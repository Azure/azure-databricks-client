...
namespace Microsoft.Azure.Databricks.Client
{
    public interface ILibrariesApi
    {
        ...
        /// </summary>
        Task<IDictionary<string, IEnumerable<LibraryFullStatus>>> AllClusterStatuses();
        ...
        Task<IEnumerable<LibraryFullStatus>> ClusterStatus(string clusterId);
        ...
        Task Install(string clusterId, IEnumerable<Library> libraries);
        ...
        Task Uninstall(string clusterId, IEnumerable<Library> libraries);
    }
}
