...
| :new: [SQL Warehouses](https://docs.databricks.com/api/azure/workspace/warehouses)       | 2.0     | The SQL Warehouses API allows you to manage compute resources that lets you run SQL commands on data objects within Databricks SQL.                                                                                   |
| :new: [Repos](https://docs.databricks.com/api/azure/workspace/repos)                     | 2.0     | The Repos API allows users to manage their git repos. Users can use the API to access all repos that they have manage permissions on.                                                                                 |
