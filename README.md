...
| [Global Init Scripts](https://docs.microsoft.com/en-us/azure/databricks/dev-tools/api/latest/global-init-scripts) | 2.0     | The Global Init Scripts API lets Azure Databricks administrators add global cluster initialization scripts in a secure and controlled manner.                                                                         |
